...
const optionalNutritionalValueValidator = (field) =>
...
module.exports = [
  ...
  body("Nutritional_values").optional().isObject().withMessage("Nutritional values must be an object"),
  optionalNutritionalValueValidator("calories"),
  optionalNutritionalValueValidator("proteins"),
